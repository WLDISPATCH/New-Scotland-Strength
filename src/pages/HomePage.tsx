...
export default function HomePage() {
  ...
  return (
    <>
      ...
      >
        <p className="mb-8 max-w-2xl text-sm leading-7 text-[var(--color-text-muted)] sm:mb-12 sm:text-lg">
          Decide which option is best for you, or{" "}
          <Link to="/contact" className="font-semibold text-[var(--color-ink)] underline underline-offset-2 hover:text-[var(--color-accent)] transition-colors">
